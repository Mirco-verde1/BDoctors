        ...
        <div class="box-general">
            <div class="profile">
                ...
                <div class="form-group d_flex_column">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control" placeholder="Insert your phone"
                        value="{{$userDetail->phone}}">
                    <br>

                    <label for="curriculum"><b>Curriculum</b></label>
                    <textarea class="form-control" id="curriculum" name="curriculum"
                        rows="6">{{$userDetail->curriculum}}</textarea>`
    ...
    <div class="row">
        <div class="margin-top-container text-left row">
            <div class="col-lg-7 col-md-7 text">
                ...
                <br>
                <span class="bottom-text">Clicca <a href="/admin/doc/{{$user->id}}/edit">qui</a> per tornare alle
                    modifiche del tuo profilo.</span>
            </div>
